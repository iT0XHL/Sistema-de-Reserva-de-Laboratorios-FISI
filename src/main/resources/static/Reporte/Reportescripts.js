...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (transitionContainer) {
        // Esperamos un poquito y luego lanzamos la animación de salida
        setTimeout(() => {
    ...
    // Navegación de items de nivel 1 del sidebar
    ...
    // Items dentro del submenú (Pendientes, Historial, etc.)
    ...
    document.querySelectorAll('.dropdown-item[data-link]').forEach(btn => {
        btn.addEventListener('click', function (e) {
            ...
            if (destino) {
                window.location.href = destino;   // /perfil o /gestor/perfil
            }
        });
    });

    // ==========================
    // 5. Logout (usa data-rol)
    // ==========================
